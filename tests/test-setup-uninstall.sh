...
mkdir -p "${HOME}/.local/share/gnome-shell/extensions/caffeine@patapon.info" "${HOME}/.local/share/gnome-shell/extensions/project@test"
printf 'project extension\n' > "${HOME}/.local/share/gnome-shell/extensions/caffeine@patapon.info/metadata.json"
...
[[ ! -e "${HOME}/.local/share/gnome-shell/extensions/caffeine@patapon.info" ]]
